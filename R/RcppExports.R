...
#' @export
cpp_pGreaterGrades <- function(GRADE, EXAM, THETA_IRT, THETA_LAT, COVARIATES, N_GRADES, N_EXAMS, ABILITY, LOGFLAG, LATPARFLAG) {
    .Call(`_crirt_cpp_pGreaterGrades`, GRADE, EXAM, THETA_IRT, THETA_LAT, COVARIATES, N_GRADES, N_EXAMS, ABILITY, LOGFLAG, LATPARFLAG)
}

#' @export
cpp_pGrade <- function(GRADE, EXAM, THETA_IRT, THETA_LAT, COVARIATES, N_GRADES, N_EXAMS, ABILITY, LOGFLAG, LATPARFLAG) {
    .Call(`_crirt_cpp_pGrade`, GRADE, EXAM, THETA_IRT, THETA_LAT, COVARIATES, N_GRADES, N_EXAMS, ABILITY, LOGFLAG, LATPARFLAG)
}

#' @export
cpp_pTimeExam <- function(EXAM, DAY, THETA_IRT, THETA_LAT, COVARIATES, N_GRADES, N_EXAMS, SPEED, ABILITY, CDFFLAG, LOGFLAG, LATPARFLAG) {
    .Call(`_crirt_cpp_pTimeExam`, EXAM, DAY, THETA_IRT, THETA_LAT, COVARIATES, N_GRADES, N_EXAMS, SPEED, ABILITY, CDFFLAG, LOGFLAG, LATPARFLAG)
}
